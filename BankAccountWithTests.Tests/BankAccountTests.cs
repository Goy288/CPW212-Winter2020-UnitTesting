...
namespace BankAccountWithTests.Tests
{
    ...
    public class BankAccountTests
    {
        ...
        [DataRow("ABC123#!@")]
        [DataRow("☺")]
        public void Constructor_ValidAccNum_SetsAccountNumber
            (string accNum)
        {
            // Arrange/Act
        ...
        [DataRow("")]
        [DataRow(" ")]
        public void Constructor_InvalidAccNum_ThrowsArgumentException
            (string accNum)
        {
            Assert.ThrowsException<ArgumentException>
                (() => new BankAccount(accNum));
        ...
        [DataRow(.01)]
        [DataRow(9999999.99)]
        [DataRow(9.000001)] // We are not losing precision for this example
        [DataRow(9.999999)]
        [TestMethod]
